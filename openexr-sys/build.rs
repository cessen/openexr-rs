...
fn main() {
    if let Ok(_) = std::env::var("DOCS_RS") {
        // We're being built by docs.rs, which only needs to generate
        // documentation.  So we can skip actually finding the C++ libs,
        // building and linking our C wrapper, etc.
    } else {
